Ext.define('myschoolishness.controller.Login', {
	...
	config: {
		...
		control: {
			...
			mainView: {
				...
				showMyKidsHome: 'showMyKidsHome',
				showDirectoryHome: 'showDirectoryHome',
				showClassHome: 'showClassHome',
				showSchoolHome: 'showSchoolHome',
	...
	showMyKidsHome: function (sender,title,message) {
		var myKidsHome = this.getMyKidsHome();
		myKidsHome.loadData();
		Ext.Viewport.animateActiveItem(myKidsHome,myschoolishness.controller.Utils.getDefaultSlideTransition());
	},
